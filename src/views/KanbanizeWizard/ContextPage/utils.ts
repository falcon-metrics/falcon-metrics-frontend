      ...
      yup.object().shape({
        ...
        cost: yup
          ...
          .test(
            ...
            "The total cost of 2nd-tier boards is greater than the cost of 1st-tier board.",
            function (value) {
          ...
          yup.object().shape({
            ...
            cost: yup
              ...
              .test(
                ...
                "The total cost of 3rd-tier boards is greater than the cost of 2nd-tier board.",
                function (value) {
