...
// TODO: add spec.ts i.e custom-fields.spec.ts on the filename to be considered as playwright test.
...
test.describe('Manage Custom Fields', () => {
    test('should contain custom fields', async ({ page }) => {
